...
const Home: NextPage = () => {
    ...
    return (
        <>
            ...
            <main className="flex flex-col min-h-screen lg:items-center bg-grayish-cyan-200 justify-start lg:justify-center">
                <Header height='flex h-12 md:h-36 lg:h-auto lg:-mt-20' />
                <div className='flex flex-col justify-evenly rounded-3xl bg-white md:min-h-fit md:rounded-t-3xl p-7 lg:p-11 lg:w-2/3 2xl:w-1/2 lg:rounded-3xl lg:flex-row lg:mt-16 lg:h-1/2 lg:gap-11 gap-4'>
