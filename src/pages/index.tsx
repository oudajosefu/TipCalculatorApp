    ...
    return (
        <>
            ...
            <main className="grid min-h-screen md:grid-rows-[auto_1fr] lg:flex lg:flex-col lg:items-center bg-grayish-cyan-200 lg:justify-center">
                ...
                <div className='flex flex-col rounded-3xl bg-white md:min-h-fit md:rounded-t-3xl px-7 py-4 lg:p-11 lg:w-2/3 2xl:w-1/2 lg:rounded-3xl lg:flex-row lg:mt-16 lg:h-1/2 lg:gap-11 gap-2'>
